...
### How it functios
The CLI tool asks for user consent to install Ansible on user's machine.
Next choice,is given to install docker and kubernetes on the remote host in private cloud.
